...
class FacAcadListView(View):
    ...
    def post(self,request,user,pk):
        ...
        return render(request,self.template_name,{'i14':i14,'i13':i13,'i12':i12,'i11':i11,'i10':i10,'i9':i9,'i8':i8,'i7':i7,'i6':i6,'i':i,'i2':i2,'i3':i3,'i4':i4,'i5':i5,'user1':user1})
...
class ResponsesView(View):
    ...
    def get(self,request):
        ...
        i14 = OnlineCourse.objects.all().filter(user=user)
        flag2=1
        return render(request,self.template_name,{'i14':i14,'i13':i13,'i12':i12,'i11':i11,'i10':i10,'i9':i9,'i8':i8,'i6':i6,'i7':i7,'i':i,'i2':i2,'i3':i3,'i4':i4,'i5':i5,'flag2':flag2})
    ...
    def post(self,request):
        ...
        return render(request,self.template_name,{'i14':i14,'i13':i13,'i12':i12,'i11':i11,'i10':i10,'i9':i9,'i8':i8,'i7':i7,'i6':i6,'i':i,'i2':i2,'i3':i3,'i4':i4,'i5':i5})
